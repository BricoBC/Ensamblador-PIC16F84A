...
SOURCEFILES_QUOTED_IF_SPACED=BCDoutput.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/BCDoutput.o
POSSIBLE_DEPFILES=${OBJECTDIR}/BCDoutput.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/BCDoutput.o

# Source Files
SOURCEFILES=BCDoutput.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/BCDoutput.o: BCDoutput.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BCDoutput.o 
	${MP_AS} -mcpu=PIC16F84A -c \
	-o ${OBJECTDIR}/BCDoutput.o \
	BCDoutput.s \
...
dist/${CND_CONF}/${IMAGE_TYPE}/Examen.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o dist/${CND_CONF}/${IMAGE_TYPE}/Examen.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
